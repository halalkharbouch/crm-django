...
from django.views.generic import TemplateView, ListView, DeleteView, CreateView, UpdateView, DetailView, FormView
...
class LeadDetailView(LoginRequiredMixin, DeleteView):
